...
$query = "SELECT * FROM activities ORDER BY created_at DESC LIMIT 50";
...
<div class="content">
    ...
    <div class="container mt-4">
        <?php if (!$tableExists): ?>
            <div class="alert alert-warning">Activities table does not exist. Please refresh or contact admin.</div>
